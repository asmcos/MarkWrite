...
async function registerMarkWriteTools(registry, options = {}) {
  ...
  registry.register(
    ...
    tool({
      ...
      parameters: z.object({ path: z.string().describe('目标文件路径，可为绝对路径或相对当前工作目录的路径，例如 1245.txt 或 /path/to/1245.txt') }),
...
async function getMarkWriteToolsForLangChain(options = {}) {
  ...
  tools.push(
    new DynamicStructuredTool({
      ...
      schema: z.object({ path: z.string().describe('目标文件路径，可为绝对路径或相对当前工作目录的路径') }),
